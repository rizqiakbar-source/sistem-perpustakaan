...
<div class="main-content">
    ...
    <div class="card-custom">
        <div class="card-title"><span class="icon">📱</span> E-Book Collection</div>
        <div class="row">
            <div class="col-md-4 col-6 mb-3">
                <div class="card text-center">
                    <div class="card-body">
                        <i class="fas fa-book-open" style="font-size: 48px; color: #1a237e;"></i>
                        <h6 class="mt-2">Laskar Pelangi</h6>
                        <small class="text-muted">Andrea Hirata</small>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-6 mb-3">
                <div class="card text-center">
                    <div class="card-body">
                        <i class="fas fa-book-open" style="font-size: 48px; color: #1a237e;"></i>
                        <h6 class="mt-2">Sapiens</h6>
                        <small class="text-muted">Yuval Noah Harari</small>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-6 mb-3">
                <div class="card text-center">
                    <div class="card-body">
                        <i class="fas fa-book-open" style="font-size: 48px; color: #1a237e;"></i>
                        <h6 class="mt-2">Bumi Manusia</h6>
                        <small class="text-muted">Pramoedya Ananta Toer</small>
                    </div>
                </div>
            </div>
        </div>
