<?php
// views/peminjaman/index.php - Daftar Peminjaman
session_start();
...
$sql = "SELECT p.*, a.nama_lengkap as anggota, u.nama_lengkap as petugas,
...
<div class="main-content">
    ...
    <div class="top-header">
        <div class="page-title">
            ...
            <small>Kelola transaksi peminjaman buku</small>
        </div>
    </div>

    <div class="toolbar">
        <a href="tambah.php" class="btn-primary">➕ Pinjam Buku</a>
    </div>
