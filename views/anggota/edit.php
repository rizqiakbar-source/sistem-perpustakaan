<?php
// views/anggota/edit.php - Edit Anggota
session_start();
        ...
        <form method="POST">
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="nis_nim" class="form-control" value="<?= htmlspecialchars($anggota['nis_nim']) ?>" required>
                </div>
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <select name="status_aktif" class="form-control">
                        ...
                        <option value="blokir" <?= $anggota['status_aktif'] == 'blokir' ? 'selected' : '' ?>>Blokir</option>
                    </select>
                </div>
            </div>
