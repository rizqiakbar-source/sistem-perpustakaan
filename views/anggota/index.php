<?php
// views/anggota/index.php - Daftar Anggota
session_start();
...
<div class="main-content">
    ...
    <div class="toolbar">
        <input type="text" placeholder="🔍 Cari Anggota" id="searchInput" onkeyup="searchTable()">
            ...
            <tbody>
                <?php if (count($anggota) > 0): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                            $badge = 'success'; $label = 'Aktif';
                            if ($row['status_aktif'] == 'nonaktif') { $badge = 'warning'; $label = 'Nonaktif'; }
                            elseif ($row['status_aktif'] == 'blokir') { $badge = 'danger'; $label = 'Blokir'; }
                            ?>
                            <span class="badge-status <?= $badge ?>"><?= $label ?></span>
                        </td>
                        <td>
                            <a href="edit.php?id=<?= $row['anggota_id'] ?>" class="btn-sm btn-warning">✏️</a>
                            <a href="hapus.php?id=<?= $row['anggota_id'] ?>" class="btn-sm btn-danger" onclick="return confirm('Yakin hapus?')">🗑️</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                <?php else: ?>
