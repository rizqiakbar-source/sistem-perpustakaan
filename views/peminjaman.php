...
$sql = "SELECT p.*, a.nama_lengkap as nama_anggota, u.nama_lengkap as nama_petugas
        FROM peminjaman p
...
<div class="main-content">
    ...
    <div class="card-custom">
        <div class="card-title"><span class="icon">📋</span> Data Peminjaman</div>
                ...
                <tbody>
                    <?php if (count($peminjaman) > 0): ?>
                        ...
                        <tr>
                            ...
                            <td><span class="badge-status <?= $row['status'] == 'dipinjam' ? 'warning' : ($row['status'] == 'terlambat' ? 'danger' : 'success') ?>"><?= ucfirst($row['status']) ?></span></td>
                        </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
