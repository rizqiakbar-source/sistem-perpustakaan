<?php
// views/ubah_foto_anggota.php - Ubah Foto Profil Anggota dengan Crop
session_start();
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['foto_base64'])) {
    ...
    $upload_dir = '../upload/foto_anggota/';
    if (!file_exists($upload_dir)) {
        mkdir($upload_dir, 0777, true);
    }
    $file_path = $upload_dir . $anggota_id . '.jpg';
...
<head>
    ...
    <title>Ubah Foto - Perpustakaan</title>
