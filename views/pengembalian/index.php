<?php
// views/pengembalian/index.php - Daftar Pengembalian
session_start();
...
$sql = "SELECT pg.*, p.kode_transaksi, a.nama_lengkap as anggota, u.nama_lengkap as petugas
...
<div class="main-content">
    ...
    <div class="top-header">
        <div class="page-title">
            ...
            <small>Kelola transaksi pengembalian buku</small>
        </div>
    </div>

    <div class="toolbar">
        <a href="tambah.php" class="btn-primary">➕ Proses Pengembalian</a>
    </div>
            ...
            <tbody>
                <?php if (count($pengembalian) > 0): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge-status <?= $row['status'] == 'lengkap' ? 'success' : 'warning' ?>">
                                <?= ucfirst($row['status']) ?>
                            </span>
                        </td>
                    </tr>
