...
$sql = "SELECT pg.*, p.kode_transaksi, a.nama_lengkap as nama_anggota, u.nama_lengkap as nama_petugas
...
$pengembalian = $pdo->query($sql)->fetchAll();
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        .table-custom thead th { text-align: left; padding: 10px 8px; border-bottom: 2px solid var(--border-color); color: #888; font-weight: 600; font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px; }
        .table-custom tbody td { padding: 10px 8px; border-bottom: 1px solid var(--border-color); }
        .table-custom tbody tr:hover { background: var(--bg-body); }
        .badge-status { padding: 3px 12px; border-radius: 20px; font-size: 11px; font-weight: 600; }
...
<div class="main-content">
    ...
    <div class="card-custom">
        <div class="card-title"><span class="icon">↩️</span> Data Pengembalian</div>
